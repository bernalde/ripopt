...
Generated: 2026-03-20 00:23:28

## Executive Summary

| Metric | ripopt | Ipopt |
|--------|--------|-------|
| Optimal | **687/865** (79.4%) | **688/865** (79.5%) |
| Acceptable | 0 | 5 |
| Total solved (Optimal + Acceptable) | 687 (79.4%) | 693 (80.1%) |
| Solved exclusively | 43 | 49 |
| Both solved | 644 | |
| Matching objectives (< 0.01%) | 544/644 | |
...
|-------|----------|--------------|-------------|-------------|------------|------------|-------|
| HS | 120 | 118 (98.3%) | 116 (96.7%) | 2 | 0 | 116 | 107/116 |
| CUTEst | 727 | 552 (75.9%) | 561 (77.2%) | 40 | 49 | 512 | 422/512 |
| Electrolyte | 13 | 13 (100.0%) | 12 (92.3%) | 1 | 0 | 12 | 12/12 |
| OPF | 4 | 4 (100.0%) | 4 (100.0%) | 0 | 0 | 4 | 3/4 |
...
| Metric | ripopt | Ipopt |
|--------|--------|-------|
| Median time | 144us | 1.9ms |
| Total time | 35.1ms | 277.0ms |
| Mean iterations | 16.4 | 13.3 |
| Median iterations | 12 | 10 |
...
On 512 commonly-solved problems:

| Metric | ripopt | Ipopt |
|--------|--------|-------|
| Median time | 82us | 2.1ms |
| Total time | 20.82s | 10.42s |
| Mean iterations | 42.8 | 37.9 |
| Median iterations | 15 | 12 |

- **Geometric mean speedup**: 14.9x
- **Median speedup**: 27.2x
- ripopt faster: 460/512 (90%)
- ripopt 10x+ faster: 351/512
- Ipopt faster: 52/512
...
| Metric | ripopt | Ipopt |
|--------|--------|-------|
| Median time | 122us | 1.5ms |
| Total time | 1.7ms | 55.0ms |
| Mean iterations | 22.3 | 19.2 |
| Median iterations | 9 | 7 |

- **Geometric mean speedup**: 22.0x
- **Median speedup**: 20.7x
...
| Metric | ripopt | Ipopt |
|--------|--------|-------|
| Median time | 8.2ms | 10.7ms |
| Total time | 1.84s | 72.9ms |
| Mean iterations | 24.8 | 12.5 |
| Median iterations | 35 | 14 |
...
| HATFLDF | CUTEst | 3 | 3 | NumericalError | 0.000000e+00 |
...
| KIRBY2LS | CUTEst | 5 | 0 | NumericalError | 3.905074e+00 |
| KSIP | CUTEst | 20 | 1001 | NumericalError | 5.757979e-01 |
...
| PENTAGON | CUTEst | 6 | 15 | NumericalError | 1.365217e-04 |
| PFIT4 | CUTEst | 3 | 3 | NumericalError | 0.000000e+00 |
| SIPOW3 | CUTEst | 4 | 2000 | NumericalError | 5.346586e-01 |
| SIPOW4 | CUTEst | 4 | 2000 | NumericalError | 2.723620e-01 |
...
| TFI2 | CUTEst | 3 | 101 | NumericalError | 6.490311e-01 |
...
| VIBRBEAM | CUTEst | 8 | 0 | NumericalError | 3.322376e-01 |
...
| DECONVB | CUTEst | 63 | 0 | MaxIterations | 7.989294e-06 |
...
| LEWISPOL | CUTEst | 6 | 9 | IpoptStatus(-10) | 1.211754e+00 |
| MESH | CUTEst | 41 | 48 | IpoptStatus(4) | -6.140630e+08 |
...
|---------|---|---|--------|-------|------|-------|-------|------|---------|
| Rosenbrock 500 | 500 | 0 | Optimal | 81 | 0.002s | Optimal | 749 | 0.203s | 83.5x |
| SparseQP 1K | 500 | 500 | Optimal | 8 | 0.046s | Optimal | 6 | 0.005s | 0.1x |
...
| Rosenbrock 5K | 5,000 | 0 | Optimal | 82 | 0.152s | Failed | 3000 | 4.274s | 28.0x |
| Poisson 2.5K | 5,000 | 2,500 | Optimal | 1 | 0.028s | Optimal | 1 | 0.011s | 0.4x |
| Bratu 10K | 10,000 | 9,998 | Optimal | 11 | 0.127s | Optimal | 2 | 0.012s | 0.1x |
| OptControl 20K | 19,999 | 10,000 | Optimal | 1 | 0.194s | Optimal | 1 | 0.020s | 0.1x |
| Poisson 50K | 49,928 | 24,964 | Optimal | 1 | 1.738s | Optimal | 1 | 0.128s | 0.1x |
| SparseQP 100K | 50,000 | 50,000 | Optimal | 8 | 4.813s | Optimal | 6 | 0.319s | 0.1x |

ripopt: **10/10 solved** in 7.1s total
Ipopt: **9/10 solved** in 5.0s total

...
Generated: 2026-03-14 15:53:58

## Executive Summary

| Metric | ripopt | Ipopt |
|--------|--------|-------|
| Total solved | **717/847** (84.7%) | 677/847 (79.9%) |
| Optimal | 483 | 672 |
| Acceptable | 234 | 5 |
| Solved exclusively | 50 | 10 |
| Both solved | 667 | |
| Matching objectives | 525/667 | |

## Per-Suite Summary

| Suite | Problems | ripopt solved | Ipopt solved | ripopt only | Ipopt only | Both solved | Match |
|-------|----------|--------------|-------------|-------------|------------|------------|-------|
| HS | 120 | 119 (99.2%) | 116 (96.7%) | 3 | 0 | 116 | 107/116 |
| CUTEst | 727 | 598 (82.3%) | 561 (77.2%) | 47 | 10 | 551 | 418/551 |
...
| Metric | ripopt | Ipopt |
|--------|--------|-------|
| Median time | 108us | 1.8ms |
| Total time | 43.0ms | 276.7ms |
| Mean iterations | 16.0 | 13.3 |
| Median iterations | 11 | 10 |

- **Geometric mean speedup**: 15.0x
- **Median speedup**: 15.7x
- ripopt faster: 113/116 (97%)
- ripopt 10x+ faster: 81/116
- Ipopt faster: 3/116
...
| Metric | ripopt | Ipopt |
|--------|--------|-------|
| Median time | 153us | 2.7ms |
| Total time | 101.03s | 18.70s |
| Mean iterations | 118.5 | 41.1 |
| Median iterations | 18 | 12 |

- **Geometric mean speedup**: 7.8x
- **Median speedup**: 21.0x
- ripopt faster: 439/551 (80%)
- ripopt 10x+ faster: 345/551
- Ipopt faster: 112/551
...
|---------|-------|---|---|--------------|-----------|
| ACOPR14 | CUTEst | 38 | 82 | Timeout | 8.081526e+03 |
...
## Wins (ripopt solves, Ipopt fails) — 50 problems
...
## Acceptable (not Optimal) — 234 problems
...
| BATCH | CUTEst | 48 | 73 | Optimal | 2.592099e+05 | 2.591803e+05 |
...
| DEMBO7 | CUTEst | 16 | 20 | Optimal | 1.748430e+02 | 1.747870e+02 |
...
| DUALC2 | CUTEst | 7 | 229 | Optimal | 3.578584e+03 | 3.551303e+03 |
| DUALC5 | CUTEst | 8 | 278 | Optimal | 4.272326e+02 | 4.272325e+02 |
| DUALC8 | CUTEst | 8 | 503 | Optimal | 1.824353e+04 | 1.830936e+04 |
...
| EXPFITC | CUTEst | 5 | 502 | Optimal | 5.065050e+00 | 2.330262e-02 |
...
| HS109 | CUTEst | 9 | 10 | Optimal | 5.362069e+03 | 5.362069e+03 |
| HS116 | CUTEst | 13 | 14 | Optimal | 9.686865e+01 | 9.758747e+01 |
...
| LAUNCH | CUTEst | 25 | 28 | Optimal | 9.005116e+00 | 9.004902e+00 |
...
| OET1 | CUTEst | 3 | 1002 | Optimal | 5.381507e-01 | 5.382431e-01 |
| OET2 | CUTEst | 3 | 1002 | Optimal | 8.709576e-02 | 8.715962e-02 |
| OET3 | CUTEst | 4 | 1002 | Optimal | 4.824337e-03 | 4.505043e-03 |
...
| PORTFL6 | CUTEst | 12 | 1 | Optimal | 2.579229e-02 | 2.579180e-02 |

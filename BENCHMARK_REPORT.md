...
## Large-Scale Problems (ripopt only)

Synthetic problems with known structure, up to 100K variables.
No Ipopt comparison (problems defined in Rust, not available as NL files).

| Problem | n | m | KKT dim | Status | Objective | Iters | Time |
|---------|---|---|---------|--------|-----------|-------|------|
| Chained Rosenbrock 500 | 500 | 0 | 500 | Acceptable | 6.0269e-14 | 70 | 0.002s |
| Sparse QP 1K | 500 | 500 | 1,000 | Optimal | -1.2482e+02 | 6 | 0.008s |
| Bratu BVP 1K | 1,000 | 998 | 1,998 | Optimal | 0.0000e+00 | 3 | 0.018s |
| Poisson Control 2.5K | 2,450 | 1,225 | 3,675 | Optimal | 9.9445e-02 | 1 | 0.023s |
| Optimal Control 2.5K | 2,499 | 1,250 | 3,749 | Optimal | 2.6422e-14 | 73 | 0.029s |
| Chained Rosenbrock 5K | 5,000 | 0 | 5,000 | Acceptable | 1.1807e-01 | 9 | 0.103s |
| Bratu BVP 10K | 10,000 | 9,998 | 19,998 | Optimal | 0.0000e+00 | 11 | 0.164s |
| Optimal Control 20K | 19,999 | 10,000 | 29,999 | Optimal | 9.9470e-02 | 1 | 1.751s |
| Poisson Control 50K | 49,928 | 24,964 | 74,892 | Acceptable | 1.7708e-01 | 6 | 2.796s |
| Sparse QP 100K | 50,000 | 50,000 | 100,000 | Optimal | -1.2500e+04 | 6 | 20.218s |

**10/10 solved** in 25.1s total

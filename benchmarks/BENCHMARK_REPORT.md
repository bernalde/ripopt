...
| Solved exclusively | 39 | 36 |
| Both solved | 657 | |
| Matching objectives (< 0.01%) | 561/657 | |
...
| CUTEst | 727 | 562 (77.3%) | 561 (77.2%) | 36 | 35 | 526 | 436/526 |
...
| Metric | ripopt | Ipopt |
|--------|--------|-------|
| Median time | 55us | 2.4ms |
| Total time | 46.4ms | 346.0ms |
| Mean iterations | 70.8 | 13.3 |
| Median iterations | 13 | 10 |

- **Geometric mean speedup**: 41.0x
- **Median speedup**: 41.4x
- ripopt faster: 113/116 (97%)
- ripopt 10x+ faster: 112/116
- Ipopt faster: 3/116
...
| Metric | ripopt | Ipopt |
|--------|--------|-------|
| Median time | 189us | 2.8ms |
| Total time | 171.00s | 19.43s |
| Mean iterations | 84.0 | 42.9 |
| Median iterations | 15 | 12 |

- **Geometric mean speedup**: 7.6x
- **Median speedup**: 12.8x
- ripopt faster: 448/526 (85%)
- ripopt 10x+ faster: 308/526
- Ipopt faster: 78/526
...
| Metric | ripopt | Ipopt |
|--------|--------|-------|
| Median time | 2.2ms | 11.2ms |
| Total time | 10.9ms | 29.2ms |
| Mean iterations | 15.7 | 12.0 |
| Median iterations | 14 | 11 |

- **Geometric mean speedup**: 4.0x
- **Median speedup**: 2.4x
- ripopt faster: 3/3 (100%)
- ripopt 10x+ faster: 1/3
- Ipopt faster: 0/3
...
| LINSPANH | CUTEst | 97 | 33 | Timeout | -7.700005e+01 |
...
| case30_ieee | Grid | 72 | 142 | RestorationFailed | 8.208515e+03 |

## Wins (ripopt solves, Ipopt fails) — 39 problems
